...
- Erkennt besuchte Twitch-Kanaele und speichert sie lokal im Browser.
- Zaehlt grob Watchtime und Sessions, solange der Twitch-Tab aktiv ist.
- Ergaenzt die Twitch-Following-Seite um einen eigenen `History`-Tab.
...
OAuth ist optional, wird aber fuer genauere Twitch-API-Daten genutzt: Live-Status, Zuschauerzahlen, Profilbilder und aktuelle Stream-Metadaten.
